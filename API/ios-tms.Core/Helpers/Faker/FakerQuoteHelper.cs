...
public class FakerQuoteHelper
{
    ...
    public static Faker<Quote> GetConfig()
    {
        return new Faker<Quote>()
                ...
                .RuleFor(s => s.PickupDate, f => f.Date.Soon());
                //.RuleFor(s => s.QuoteRates, f => GetRateConfig().Generate(f.Random.Int(1, 8)));
    }

    public static Faker<QuoteRate> GetRateConfig(int quoteId, DateTime quotedPickupDate)
    {
        ...
        return new Faker<QuoteRate>()
            ...
            .RuleFor(s => s.PickupDate, f => f.Date.Soon(3, quotedPickupDate))
            .RuleFor(s => s.EstDeliveryDate, (f, s) => f.Date.Soon(5, s.PickupDate));
    }
}
